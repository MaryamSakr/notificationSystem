...
public class inMemoryOrder {
    ...
    static {
        ...
        o2.setId(2);
        orders.add(o2);
        ArrayList<SimpleOrder> orders1 = new ArrayList<>();
        orders1.add((SimpleOrder) orders.get(1));
        Order o3 = new CompoundOrder("Maryam", 460, 10, orders1 );
        o3.setId(3);
        orders.add(o3);
        ArrayList<SimpleOrder> orders2 = new ArrayList<>();
        orders2.add((SimpleOrder) orders.get(0));
        orders2.add((SimpleOrder) orders.get(1));
